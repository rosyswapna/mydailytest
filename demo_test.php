...
$page = new Page;
	...
	$page->class_list = array("class_quiz.php","class_question.php","class_pagination.php","class_timer.php","class_demo_test.php","class_demo_test_details.php");
