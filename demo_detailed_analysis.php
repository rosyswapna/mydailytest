...
$page = new Page;
	...
	$page->class_list = array("class_quiz.php","class_bar_graph.php","class_chart.php","class_pie_chart.php","class_demo_test.php","class_demo_test_details.php","class_user_test_reports.php","class_chart_graph.php");
	...
	$page->module		= 'demo_detailed_analysis';
