...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'report_question';		// page name for menu and other purpose
	...
	$page->class_list = array("class_user.php","class_question.php","class_user_test_details.php","class_user_test.php","class_ user_question_reportings.php");
	...
	$page->module		= 'user_reported_question_add';
