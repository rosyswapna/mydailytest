...
$page = new Page;
	...
	$page->page_name = 'challenge_question_result';		// page name for menu and other purpose
	...
	$page->class_list = array("class_quiz.php","class_question.php","class_bar_graph.php","class_chart.php","class_pie_chart.php");
	...
	$page->module		= 'challenge_questions_result';
