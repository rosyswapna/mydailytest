...
$page = new Page;
	...
	$page->class_list = array("class_credit_plan.php", "class_payment_type.php","class_user.php","class_user_session.php","class_user_notifications.php","class_user_credit.php", "class_payment.php","class_exam.php");
