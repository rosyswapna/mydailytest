...
--
-- Host: localhost
-- Generation Time: Nov 14, 2013 at 10:50 AM
...
CREATE TABLE IF NOT EXISTS `questions` (
  ...
  KEY `organization_id` (`organization_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5111 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=5519 ;
