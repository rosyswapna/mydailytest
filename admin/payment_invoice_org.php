...
$page = new Page;
	...
	$page->page_name = 'payment_invoice_org';		// page name for menu and other purpose
	...
	$page->class_list = array("class_credit_plan.php","class_payment.php","class_organization.php","class_organization_credit.php","class_payment_status.php","class_payment_type.php","class_email.php");

	$page->style_list = array("popup.css");
