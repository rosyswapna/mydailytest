...
$page = new Page;
	...
	$page->page_name = 'reported_questions';		// page name for menu and other purpose
	...
	$page->class_list = array("class_user.php","class_user_question_reportings.php","class_question_statuses.php","class_pagination.php");
    ...
    $page->module = 'user_reported_question_update';
