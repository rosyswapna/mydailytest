...
$page = new Page;
	...
	$page->page_name = 'agents';		// page name for menu and other purpose
	...
	$page->class_list = array("class_agent.php", "class_agent_notification.php","class_pagination.php");
