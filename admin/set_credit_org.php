...
$page = new Page;
	...
	$page->page_name = 'set_credit_org';		// page name for menu and other purpose
	...
	$page->class_list = array("class_organization.php","class_organization_credit.php","class_payment.php","class_credit_plan.php","class_payment_type.php");
