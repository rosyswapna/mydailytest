...
$page = new Page;
    ...
    $page->title = "Administrator - Add Set";   // page Title
	...
	$page->class_list = array("class_credit_plan.php","class_credit_plan_statuses.php");
    ...
    $page->module_path = 'modules/add_credit/'; 
    $page->module = 'credit_name_check';
