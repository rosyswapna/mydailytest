...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'change organization Password';		// page name for menu and other purpose
	...
	$page->class_list = array("class_organization.php","class_organization_notification.php");
   ...
   $content_list[$index]['file_name']='administrator/inc_menu.php';
	...
	$page->module		= 'update_organization_password_by_admin';
