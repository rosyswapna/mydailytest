...
$page = new Page;
	...
	$page->page_name = 'Bill';		// page name for menu and other purpose
	...
	$page->class_list = array("class_voucher_bill.php","class_payment.php","class_voucher.php","class_voucher_bill_items.php");
