...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'Allocate voucher';		// page name for menu and other purpose
	...
	$page->class_list = array("class_voucher.php","class_payment.php","class_agent.php","class_voucher_bill.php","class_voucher_bill_items.php");
	...
	$page->module_path 	= '/modules/voucher/';
	$page->module		= 'update';
