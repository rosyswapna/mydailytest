...
$page = new Page;
    ...
    $page->page_name = 'Groups';     // page name for menu and other purpose
	...
	$page->class_list = array("class_pagination.php","class_groups.php","class_subject.php","class_difficulty_level.php","class_exam.php","class_question_statuses.php","class_section.php");
