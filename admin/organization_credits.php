...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'organization_credits';		// page name for menu and other purpose
	...
	$page->class_list = array("class_pagination.php","class_organization_credit.php","class_organization.php");
