...
$page = new Page;
	...
	$page->class_list = array("class_question.php","class_subject.php","class_difficulty_level.php","class_language.php","class_question_statuses.php","class_groups.php","class_exam.php","class_section.php");
