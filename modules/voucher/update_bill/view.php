...
<input type="hidden" name="hd_bill_id" value="<?php echo $myvoucherbill->id; ?>"/>
           ...
           <!-- <input type="submit" class="button" value="Email" id="email_div" name="submit">-->
                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" >
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top">Bill Status: <?php echo $bill_statuses[$myvoucherbill->bill_status_id].'  '; if($myvoucherbill->bill_status_id==VOUCHER_BILL_PAID){ ?> <input type="checkbox" name="cancel_bill_chk" id="cancel_bill_chk">Cancel.<?php } else if($myvoucherbill->bill_status_id==VOUCHER_BILL_UNPAID){ ?><input type="checkbox" name="paid_bill_chk" id="paid_bill_chk">&nbsp;Paid.<input type="checkbox" name="cancel_bill_chk" id="cancel_bill_chk">Cancel.<?php } ?></td>
                        </tr>
                ...
                <tr>
                  <td colspan="2" align="center" valign="top"><table width="100%" >
					...
					while($index_items<count($data)) { if($data[$index_items]["voucher_bill_item_status_id"]==VOUCHER_BILL_ITEM_ACTIVE){ $checked='checked'; }else{ $checked=''; } ?>
                    <tr><td align="center" valign="top"><?php if($myvoucherbill->bill_status_id==VOUCHER_BILL_UNPAID){ ?><input type="checkbox" name="cancel_chk[]" value="<?php echo $data[$index_items]['id']; ?>" id="cancel_chk"<?php echo $slno; echo ' '.$checked;?> > <?php  } ?></td>
					...
					<td align="center" valign="top"><?php echo $voucher_bill_item_statuses[$data[$index_items]['voucher_bill_item_status_id']]; ?></td>
