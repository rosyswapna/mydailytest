...
$question_image_start_col='';
 $mytempquestion->error_description=$strERR;
	...
	if($_POST['txtquestionimagestartcol']!=''){
   ...
   $answer_start_col= $_POST['txtanswerstartcol']-1;
	...
	$mytempquestion->organization_id="";
   	}else{
	$mytempquestion->organization_id=$_POST['txtorganizationid'];
	}
...
//exit();
	...
	if(trim($_POST['txtexam'])== gINVALID && trim($exam_start_col)!='' && trim($data[$exam_start_col])!=''){print_r($exam);
