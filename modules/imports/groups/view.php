...
<table border="0" cellpadding="0" cellspacing="2" >
		...
		<tr>
                    <td><?php echo $CAP_passage_start_col; ?><span style="color:red">*</span></td>   
                    <td><input type="text" name="txtpassagestartcol"> 
                    </td>
                </tr>
                <tr>
                    <td><?php echo $CAP_passage_image_start_col; ?></td>   
                    <td><input type="text" name="txtpassageimagestartcol">
                    </td>
                </tr>
                ...
                <td><?php echo $CAP_exam_start_col; ?><span style="color:red">*</span></td>   
                    ...
                    <td> <?php echo $CAP_exam; ?><span style="color:red">*</span></td>   
