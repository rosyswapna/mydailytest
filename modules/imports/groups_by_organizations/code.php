...
if ( trim($_POST['txtlanguage_col']) != "" && trim($_POST['txtlangauge']) != -1 ){
 ...
 $mytempgroups->error_description=$strERR;
	...
	$mygroupimports->organization_id=$mytempgroups->organization_id;
	...
	if(trim($_POST['txtexam'])== -1 && trim($exam_start_col)!="" && trim($data[$exam_start_col])!=""){
		...
		$myexam->organization_id=$mytempgroups->organization_id;
		$myexam->update();
	...
	if(trim($_POST['txtsubject']) == -1 && trim($subject_start_col)!="" && trim($data[$subject_start_col])!=""){
		...
		$mysubject->organization_id=$mytempgroups->organization_id;
		$mysubject->update();
	...
	if(trim($_POST['txtsection'])== -1 && trim($section_col)!="" && trim($data[$section_col])!=""){
		...
		$mysection->organization_id=$mytempgroups->organization_id;
		$mysection->update();
	...
	if(trim($_POST['txtlangauge'])== -1 && trim($language_col)!="" && trim($data[$language_col])!=""){
