...
$(".update_button").click(function() {
	...
	var subject_id=$("select[name='lstsubject_"+question_id+"']").val();//alert(subject_id);
	var exam_id=$("select[name='lstexam_"+question_id+"']").val();//alert(exam_id);
...
$(".classcheck").click(function() {
	question_id=$(this).children(":input").attr('question_id');
	$('#answer_paragraph_'+question_id).html("");
	index=1;
	$("input[name='optioncheck_"+question_id+"[]']").each(function () {
	if( $(this).is(':checked') ){
