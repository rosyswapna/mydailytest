...
if ( !defined('CHECK_INCLUDED') ){
	...
	$breadcrumb='<a href="/agent/index.php">Home</a> &raquo; <a href="/agent/reset_password.php">Reset Password</a>';
    if(isset($myagent)) { $_SESSION[SESSION_TITLE.'flash'] =$myagent->error_description.$passwd_error ; }?>
