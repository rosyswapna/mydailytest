...
<tr>
                    <td>
                        <?php echo $CAP_agent_status_id?>
                    </td>   
                    <td><?php populate_array("txtagent_status",$agent_statuses,$myagent->agent_status_id,$disable=false); ?>  
                    </td>
                </tr>
 <tr>
      <td>&nbsp;</td>
...
<table  border="0" cellpadding="1px" cellspacing="1px">
    ...
    <tr>
        ...
        <th><?php echo $CAP_name?></th>
         <th><?php echo $CAP_agent_status_id?></th>
	...
	<th><?php echo $CAP_phone?></th>
     ...
     while ( $count_data_bylimit > $index ){
        $link = "agent.php?id=".$data_bylimit[$index]["id"]."";
	    $link_reset_pswd="update_agent_password.php?id=".$data_bylimit[$index]["id"]."";
    ...
    <tr onmouseover="this.className='row_highlight'" onmouseout="this.className='<?php echo $style; ?>'"  class="<?php echo $style; ?>" >
        ...
        <td><?php echo $agent_statuses[$data_bylimit[$index]["agent_status_id"]]; ?></td>
