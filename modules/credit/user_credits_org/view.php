...
<form action="<?php echo $current_url; ?>" method="post" name="frm_credit_history"/>
...
<div class="innercontainer-blk">
	...
	<div class="credit-balance">
		...
		<div class="dblk">
			...
			<p class="fright">
				User:<?php populate_list_array("lstuser", $my_users, "id", "username", $myusercredit->user_id,$disable=false); ?>
				<input type="submit" value="Search" class="button"  name="submit" /></a>
			</p>
		</div>
	</div>

	<p class="heading">
		<span class="fleft"><?php echo $CAP_user_credits; ?></span>
