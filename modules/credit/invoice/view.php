...
<input type="hidden" name="hd_uid" value="<?php echo $myuser->id; ?>"/>
                ...
                <tr>
                  <td width="50%" align="left" valign="top"><table width="100%" >
                    ...
                    <tr>
                      ...
                      <td width="71%" align="left" valign="top"><?php  echo $myuser->first_name." ".$myuser->last_name;?></td>
                    </tr>
                    <tr>
                      <td align="left" valign="top">Address:</td>
                      <td align="left" valign="top"><?php echo $myuser->address;?></td>
                    </tr>
                    <tr>
                      <td align="left" valign="top">Email:</td>
                      <td align="left" valign="top"><?php  echo $myuser->email;?></td>
                    </tr>
                    <tr>
                      <td align="left" valign="top">Mobile: </td>
                      <td align="left" valign="top"><?php echo $myuser->phone;?></td>
                    </tr>
                  </table></td>
                  <td width="50%" align="left" valign="top"><table width="100%" >
                    <tr>
                    ...
                    <tr>
                      <td align="left" valign="top">Registration ID: <?php echo $myuser->id;?></td>
                    </tr>
                    <tr>
