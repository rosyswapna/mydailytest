...
$mygroupsimports->organization_id=$_SESSION[SESSION_TITLE.'userid'];

	 $mygroupsimports->get_count_passages();
	$mytempgroups->question_group_import_id=$question_group_import_id;
	$mytempgroups->organization_id=$_SESSION[SESSION_TITLE.'userid'];
	$chk_org_existence=$mytempgroups->organization_existence();
...
if(isset($_POST['submit'])){
	...
	$mygroups->organization_id =$data[$group_index]["organization_id"];
