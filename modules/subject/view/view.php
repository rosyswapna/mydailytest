...
<table>
	   ...
	   <td><a style="float:right; color:#000" href="subject.php">Add Subject</a> <br />Search   <input  name="txtsubject"  value="<?php if(isset($_GET['txtsubject'])){
	  
	  echo $_GET['txtsubject'];
	  }
		  ?>" >
...
<table  border="0" cellpadding="1px" cellspacing="1px">
		...
		<tr onmouseover="this.className='row_highlight'" onmouseout="this.className='<?php echo $style; ?>'"  class="<?php echo $style; ?>" >
				...
				<td align="center"><a href="subject.php?id=<?php echo $data[$index]["id"]; ?>">edit</a></td>
				<td align="center"><a href="subject.php?delid=<?php echo $data[$index]["id"]; ?>">delete</a></td>
