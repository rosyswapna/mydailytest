...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'voucher_bill';		// page name for menu and other purpose
	...
	$page->class_list = array("class_agent","class_voucher_bill.php","class_payment.php","class_voucher.php","class_voucher_bill_items.php");
