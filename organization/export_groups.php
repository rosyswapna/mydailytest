...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'Export groups';		// page name for menu and other purpose
	...
	$page->class_list = array("class_temp_groups.php","class_groups.php","class_groups_import.php");
	...
	$page->module		= 'export_groups_to_db_by_organizations';
