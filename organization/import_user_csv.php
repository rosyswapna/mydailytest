...
$page = new Page;
	...
	$page->title = "Csv User Import";	// page Title
	...
	$page->class_list = array("class_user.php","class_organization.php","class_user_credit.php","class_organization_credit.php");
    ...
    $page->module = 'import_user_csv_organization';
