...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'Update groups';		// page name for menu and other purpose
	...
	$page->class_list = array("class_groups_import.php","class_exam.php","class_temp_groups.php","class_subject.php");
