...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->class_list = array("class_organization.php", "class_organization_session.php", "class_pagination.php","class_quiz.php");
	$page->style_list = array("user_dashboard.css" );
