...
$page = new Page;
	...
	$page->page_name = 'import_questions';		// page name for menu and other purpose
	...
	$page->class_list = array("class_zip_extract.php","class_question_import.php","class_subject.php","class_exam.php","class_organization.php","class_temp_question.php","class_difficulty_level.php","class_section.php","class_language.php");
    ...
    $page->module = 'questions_by_organizations';
