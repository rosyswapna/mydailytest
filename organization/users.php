...
$page = new Page;
	...
	$page->class_list = array("class_user.php","class_organization.php", "class_organization_notification.php","class_pagination.php");
    ...
    $page->module_path = 'modules/user/'; 
     $page->module = 'list_user_organization';
