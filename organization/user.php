...
$page = new Page;
	...
	$page->class_list = array("class_user.php","class_organization.php","class_organization_notifications.php","class_user_notifications.php","class_user_credit.php","class_organization_credit.php");
   ...
   $index=0;
	...
	$page->content_list = $content_list;
     ...
     $page->module = 'update_user_organization';
