...
$page = new Page;
    ...
    $page->page_name = 'question';     // page name for menu and other purpose
	...
	$page->class_list = array("class_question.php","class_subject.php","class_difficulty_level.php","class_groups.php","class_language.php","class_question_statuses.php","class_exam.php","class_section.php");
    ...
    $page->module = 'update_organization_questions';
