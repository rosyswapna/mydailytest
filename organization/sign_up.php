...
$page = new Page;
	...
	$page->page_name = 'Sing_up';		// page name for menu and other purpose
	...
	$page->class_list = array("class_organization.php","class_organization_session.php","class_organization_notification.php");
