...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->page_name = 'Update Question';		// page name for menu and other purpose
	...
	$page->class_list = array("class_temp_question.php","class_exam.php","class_subject.php");
	...
	$page->module		= 'update _tempquestion_organization';
