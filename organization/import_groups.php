...
$page = new Page;
	...
	$page->page_name = 'import groups';		// page name for menu and other purpose
	...
	$page->class_list = array("class_pagination.php","class_groups_import.php");
    ...
    $page->module_path = 'modules/imports/'; 
     $page->module = 'list_group_imports_by_organizations';
