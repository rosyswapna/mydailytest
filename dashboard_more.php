...
require(ROOT_PATH.'include/class/class_page/class_page.php');	// new Page Class
	...
	$page->class_list = array("class_user.php","class_user_credit.php", "class_user_session.php","class_quiz.php", "class_pagination.php", "class_user_test.php","class_exam.php");
