...
$page = new Page;
	...
	$page->class_list = array("class_question.php","class_user_test.php","class_user_test_details.php","class_pagination.php","class_quiz.php","class_user_test_rules.php","class_user_test_reports.php","class_chart_graph.php");
