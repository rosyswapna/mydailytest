...
$page = new Page;
	...
	$page->page_name = 'test_start.php';		// page name for menu and other purpose
	...
	$page->class_list = array( "class_user_credit.php", "class_user_test.php", "class_user_test_details.php", "class_pagination.php", "class_timer.php", "class_quiz.php", "class_quiz_detail.php","class_user_test_rules.php");
